...
const apiKey = 'a0076a2ada2f5cac32be52682324e11e';
...
app.get('/search/*', function (req, res) {
    ...
    const searchURL = 'https://api.themoviedb.org/3/search/multi?api_key=a0076a2ada2f5cac32be52682324e11e&language=en-US&query=' + req.url.substring(8);
...
app.get('/person/*', function (req, res) {
    const castURL = 'https://api.themoviedb.org/3/person/' + req.url.substring(8) + '?api_key=a0076a2ada2f5cac32be52682324e11e&language=en-US&page=1';
    const externalURL = 'https://api.themoviedb.org/3/person/' + req.url.substring(8) + '/external_ids?api_key=a0076a2ada2f5cac32be52682324e11e&language=en-US&page=1';
    const person = {
        cast: null,
        external: null,
        alsoKnownAs: null
